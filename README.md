...
±---------------+ ±---------------+ ±---------------+ | Game | | Maze | | Dot | ±---------------+ ±---------------+ ±---------------+ | -pacman: Pacman| | -width: int | | -x: int | | -ghosts: Ghost*| | -height: int | | -y: int | | -maze: Maze | | -walls: bool[][]| | -value: int | | -level: int | | -dots: Dot[][] | ±---------------+ | -status: String| ±---------------+ | +disappear() | ±---------------+ | +draw() | ±---------------+ | +start() | | +checkCollision()| /|\ | +pause() | | +getDotAt() | | | +resume() | ±---------------+ | | +end() | /|\ | ±---------------+ | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | V V V V | | ±---------------+ | | | Pacman | | | ±---------------+ | | | -x: int | | | | -y: int | | | | -direction: String| | | | -score: int | | | | -lives: int | | | ±---------------+ | | | +move() | | | | +eat() | | | | +die() | | | ±---------------+ | | | | | | | | | | | | | | ±---------------+ | | | Ghost |<---------±------------------------+ ±---------------+ | | | -x: int | | | | -y: int | | | | -direction: String| | | | -color: String | | | | -state: String | | | ±---------------+ | | | +move() | | | | +chase() | | | | +flee() | | | ±---------------+ | | | | | | | | | | | | | | ±---------------+ | | | PowerPellet |<---------±------------------------+ ±---------------+ | | | -duration: int | | | ±---------------+ | | |
